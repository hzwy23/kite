...
type Client struct {
	...
	// session when an old one got invalidate or the connection
	// broke.
	//
	// Defaults to true.
	Reconnect bool
	...
	// *http.Client value.
	//
	// Deprecated: Set Config.ClientFunc of the local kite, that
	...
	//
	// Deprecated: Set Config.Dialer.ReadBufferSize of the local kite,
	// that owns this connection, instead.
	ReadBufferSize int

	// WriteBufferSize is the output buffer size. By default it's 4096.
	//
	// Deprecated: Set Config.Dialer.WriteBufferSize of the local kite,
	// that owns this connection, instead.
	WriteBufferSize int
